        ...
        <Text size={1} muted>
          ...
          {isHome && isSelectedHomePage === false && (
            <>
              ...
              currently assigned as the site's landing page. Select it as the
              default Home Page in Site Settings to display it at{' '}
              <code>"/"</code> and make it the first page visitors see when they
              visit the website.
              <br />
              <br />
